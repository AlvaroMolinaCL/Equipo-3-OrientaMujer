                ...
                <form method="POST" action="{{ route('roles.store') }}" class="bg-white p-4 rounded-3 shadow-sm">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input id="rol_name" type="text" class="form-control border-start-0"
                                placeholder="Por ejemplo: Admin" style="background-color: #FDF5E5;" name="rol_name"
                                value="{{ old('rol_name') }}" required autofocus>
                        </div>
                        @error('rol_name')
