                        ...
                        @foreach($presetStyles as $key => $palette)
                            <div class="col">
                                <div class="palette-card card h-100 border-0 shadow-sm hover-shadow transition-all" 
                                    ...
                                    <div class="card-header py-2" style="background-color: {{ $palette['navbar_color_1'] }}; color: {{ $palette['navbar_text_color_1'] }};">
                                        <h5 class="mb-0 text-center">{{ $palette['label'] }}</h5>
                                    </div>
                                    <div class="card-body p-3" style="background-color: {{ $palette['background_color_1'] }}; color: {{ $palette['text_color_1'] }};">
                                        ...
                                        <div class="d-flex justify-content-between small">
                                            ...
                                            <span>Fondo: <span class="badge" style="background-color: {{ $palette['background_color_1'] }}; color: {{ $palette['text_color_1'] }}">Ejemplo</span></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="mt-5 pt-4 border-top">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row g-3">
                                {{-- Logo Principal --}}
                                <div class="col-md-6">
                                    <label class="form-label fw-medium" style="color: #8C2D18;">Logo Principal Actual</label>
                                    ...
                                    <label for="logo_1" class="form-label fw-medium" style="color: #8C2D18;">Actualizar Logo Principal</label>
                                    <div class="input-group">
                                        <span class="input-group-text" style="background-color: #F5E8D0; color: #8C2D18;">
                                            <i class="bi bi-upload"></i>
                                        </span>
                                        <input type="file" class="form-control border-start-0" style="background-color: #FDF5E5;" 
                                               id="logo_1" name="logo_1" accept="image/*">
                                    </div>
                                    @error('logo_1')
                                        <div class="text-danger small mt-2">
                                            <i class="bi bi-exclamation-circle me-1"></i>{{ $message }}
                                ...
                                {{-- Logo Secundario --}}
                                <div class="col-md-6">
                                    <label class="form-label fw-medium" style="color: #8C2D18;">Logo Secundario Actual</label>
                                    ...
                                    <label for="logo_2" class="form-label fw-medium" style="color: #8C2D18;">Actualizar Logo Secundario</label>
                                    <div class="input-group">
                                        <span class="input-group-text" style="background-color: #F5E8D0; color: #8C2D18;">
                                            <i class="bi bi-upload"></i>
                                        </span>
                                        <input type="file" class="form-control border-start-0" style="background-color: #FDF5E5;" 
                                               id="logo_2" name="logo_2" accept="image/*">
                                    </div>
                                    @error('logo_2')
                                        <div class="text-danger small mt-2">
                                            <i class="bi bi-exclamation-circle me-1"></i>{{ $message }}
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <label for="background_color_1" class="form-label fw-medium" style="color: #8C2D18;">Fondo Principal</label>
                                    <div class="input-group">
                                        <span class="input-group-text" style="background-color: #F5E8D0; color: #8C2D18;">
                                ...
                                {{-- Texto 1 --}}
                                <div class="col-md-6 col-lg-4">
                                    <label for="text_color_1" class="form-label fw-medium" style="color: #8C2D18;">Texto Principal</label>
                                    <div class="input-group">
                                        <span class="input-group-text" style="background-color: #F5E8D0; color: #8C2D18;">
                                ...
                                {{-- Fondo 2 --}}
                                <div class="col-md-6 col-lg-4">
                                    <label for="background_color_2" class="form-label fw-medium" style="color: #8C2D18;">Fondo Secundario</label>
                                    <div class="input-group">
                                        <span class="input-group-text" style="background-color: #F5E8D0; color: #8C2D18;">
                                            <i class="bi bi-droplet"></i>
                                        </span>
                                ...
                                {{-- Texto 2 --}}
                                <div class="col-md-6 col-lg-4">
                                    <label for="text_color_2" class="form-label fw-medium" style="color: #8C2D18;">Texto Secundario</label>
                                    <div class="input-group">
                                        <span class="input-group-text" style="background-color: #F5E8D0; color: #8C2D18;">
                                            <i class="bi bi-fonts"></i>
                                        </span>
                                ...
                                {{-- Navbar --}}
                                <div class="col-md-6 col-lg-4">
                                    <label for="navbar_color_1" class="form-label fw-medium" style="color: #8C2D18;">Color de Navbar</label>
                                    <div class="input-group">
                                        <span class="input-group-text" style="background-color: #F5E8D0; color: #8C2D18;">
                                ...
                                {{-- Texto Navbar --}}
                                <div class="col-md-6 col-lg-4">
                                    <label for="navbar_text_color_1" class="form-label fw-medium" style="color: #8C2D18;">Texto de Navbar</label>
                                    <div class="input-group">
                                        <span class="input-group-text" style="background-color: #F5E8D0; color: #8C2D18;">
                                ...
                                {{-- Botón Sidebar --}}
                                <div class="col-md-6 col-lg-4">
                                    <label for="button_color_sidebar" class="form-label fw-medium" style="color: #8C2D18;">Botón Sidebar</label>
                                    <div class="input-group">
                                        <span class="input-group-text" style="background-color: #F5E8D0; color: #8C2D18;">
                                ...
                                {{-- Color Métricas --}}
                                <div class="col-md-6 col-lg-4">
                                    <label for="color_metrics" class="form-label fw-medium" style="color: #8C2D18;">Color Métricas</label>
                                    <div class="input-group">
                                        <span class="input-group-text" style="background-color: #F5E8D0; color: #8C2D18;">
                                ...
                                {{-- Color Tablas --}}
                                <div class="col-md-6 col-lg-4">
                                    <label for="color_tables" class="form-label fw-medium" style="color: #8C2D18;">Color Tablas</label>
                                    <div class="input-group">
                                        <span class="input-group-text" style="background-color: #F5E8D0; color: #8C2D18;">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row g-3">
                                {{-- Navbar --}}
                                <div class="col-md-4">
                                    <label for="navbar_font" class="form-label fw-medium" style="color: #8C2D18;">Navbar</label>
                                    <div class="input-group">
                                        <span class="input-group-text" style="background-color: #F5E8D0; color: #8C2D18;">
                                            <i class="bi bi-type"></i>
                                        </span>
                                ...
                                {{-- Títulos --}}
                                <div class="col-md-4">
                                    <label for="heading_font" class="form-label fw-medium" style="color: #8C2D18;">Títulos</label>
                                    <div class="input-group">
                                        <span class="input-group-text" style="background-color: #F5E8D0; color: #8C2D18;">
                                        ...
                                        <select id="heading_font" class="form-select border-start-0"
                                            ...
                                            <option value="Roboto"
                                                {{ old('heading_font', $tenant->heading_font) == 'Roboto' ? 'selected' : '' }}>Roboto
                                            </option>
                                            <option value="Open Sans"
                                ...
                                {{-- Cuerpo --}}
                                <div class="col-md-4">
                                    <label for="body_font" class="form-label fw-medium" style="color: #8C2D18;">Cuerpo</label>
                                    <div class="input-group">
                                        <span class="input-group-text" style="background-color: #F5E8D0; color: #8C2D18;">
