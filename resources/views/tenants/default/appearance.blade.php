    ...
    <div class="container-fluid py-4">
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <div class="mb-5">
                    <h3 class="h5 mb-3 border-bottom pb-2"><i class="bi bi-palette-fill me-2"></i>Paletas de Colores Predefinidas</h3>
                    <p class="text-muted mb-4">Selecciona una de nuestras paletas preconfiguradas o personaliza manualmente más abajo</p>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="file" class="form-control" id="logo_2" name="logo_2" accept="image/*">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row g-3">
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" id="navbar_font" name="navbar_font">
                                        <option value="Arial" {{ $tenant->navbar_font == 'Arial' ? 'selected' : '' }}>Arial</option>
                                        <option value="Roboto" {{ $tenant->navbar_font == 'Roboto' ? 'selected' : '' }}>Roboto</option>
                                        <option value="Open Sans" {{ $tenant->navbar_font == 'Open Sans' ? 'selected' : '' }}>Open Sans</option>
                                        <option value="Montserrat" {{ $tenant->navbar_font == 'Montserrat' ? 'selected' : '' }}>Montserrat</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" id="heading_font" name="heading_font">
                                        <option value="Arial" {{ $tenant->heading_font == 'Arial' ? 'selected' : '' }}>Arial</option>
                                        <option value="Roboto" {{ $tenant->heading_font == 'Roboto' ? 'selected' : '' }}>Roboto</option>
                                        <option value="Open Sans" {{ $tenant->heading_font == 'Open Sans' ? 'selected' : '' }}>Open Sans</option>
                                        <option value="Montserrat" {{ $tenant->heading_font == 'Montserrat' ? 'selected' : '' }}>Montserrat</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" id="body_font" name="body_font">
                                        <option value="Arial" {{ $tenant->body_font == 'Arial' ? 'selected' : '' }}>Arial</option>
                                        <option value="Roboto" {{ $tenant->body_font == 'Roboto' ? 'selected' : '' }}>Roboto</option>
                                        <option value="Open Sans" {{ $tenant->body_font == 'Open Sans' ? 'selected' : '' }}>Open Sans</option>
                                        <option value="Montserrat" {{ $tenant->body_font == 'Montserrat' ? 'selected' : '' }}>Montserrat</option>
                                    </select>
                                </div>
                            </div>
                        </div>
