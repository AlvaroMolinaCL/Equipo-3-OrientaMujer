    ...
    <section id="section2" class="scroll-section py-5">
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    <div class="card h-100 shadow-sm border-0 fade-in-section">
                        <img src="{{ tenantSetting('services_path_2', '/images/services/Servicio_(Predeterminado).png') }}" class="card-img-top" alt="Representación judicial">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card h-100 shadow-sm border-0 fade-in-section">
                        <img src="{{ tenantSetting('services_path_3', '/images/services/Servicio_(Predeterminado).png') }}" class="card-img-top" alt="Capacitaciones y charlas">
                        <div class="card-body">
