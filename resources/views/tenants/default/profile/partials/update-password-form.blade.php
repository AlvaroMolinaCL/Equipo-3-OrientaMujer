<section class="bg-white p-4 rounded-3 shadow-sm mb-4">
    ...
    <form method="post" action="{{ route('password.update') }}">
        ...
        <div class="mb-4">
            <label for="update_password_current_password" class="form-label fw-medium" style="color: {{ tenantSetting('text_color_1', '#8C2D18') }};">
                {{ __('Contraseña actual') }}
            </label>
            <input id="update_password_current_password" name="current_password" type="password"
                class="form-control border-0 py-2 px-3" style="background-color: {{ tenantSetting('background_color_1', '#F5E8D0') }}; border-radius: 8px;"
        ...
        <div class="mb-4">
            <label for="update_password_password" class="form-label fw-medium" style="color: {{ tenantSetting('text_color_1', '#8C2D18') }};">
                {{ __('Nueva contraseña') }}
            </label>
            <input id="update_password_password" name="password" type="password" class="form-control border-0 py-2 px-3"
                style="background-color: {{ tenantSetting('background_color_1', '#F5E8D0') }}; border-radius: 8px;" autocomplete="new-password">
        ...
        <div class="mb-4">
            <label for="update_password_password_confirmation" class="form-label fw-medium" style="color: {{ tenantSetting('text_color_1', '#8C2D18') }};">
