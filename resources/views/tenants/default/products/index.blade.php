...
@section('title', 'Lista de Planes - ' . tenantSetting('name', 'Tenant'))
    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3 class="fw-bold mb-0" style="color: {{ tenantSetting('text_color_1', '#8C2D18') }};">
                <i class="bi bi-card-checklist me-2"></i>Lista de Planes
            </h3>
        ...
        <div class="card mb-4 border-0 shadow-sm">
            <div class="card-header d-flex justify-content-between align-items-center" style="background-color: {{ tenantSetting('color_tables', '#8C2D18') }};
                ...
                {{-- Botón Crear --}}
                <a href="{{ route('products.create') }}" class="btn btn-sm" style="background-color: {{ tenantSetting('background_color_1', '#FDF5E5') }};
                                       color: {{ tenantSetting('text_color_1', '#8C2D18') }};">
                                    ...
                                    <td>
                                        <div class="d-flex flex-column flex-md-row justify-content-center gap-2">
                                            <a href="{{ route('products.edit', $product) }}"
                                                ...
                                                style="background-color: #ffc107; color: black; width: 100px;">
