...
@section('title', 'Pago Cancelado - ' . tenantSetting('name', 'Tenant'))
            ...
            <div class="row justify-content-center">
                <div class="col-lg-7 col-md-10">
                    <div class="card shadow border-0 rounded-4 fade-in-section overflow-hidden">
                        ...
                        <div class="card-header position-relative bg-warning text-dark text-center py-5 rounded-top-4">
                            ...
                            <div class="position-relative z-1">
                                ...
                                <h2 class="mb-0"
                                    style="font-family: {{ tenantSetting('heading_font', 'Poppins, sans-serif') }}">Pago Cancelado</h2>
                                <p class="mt-2 mb-0 small">Has interrumpido el proceso de pago</p>
                            </div>
                        </div>
                        <div class="card-body p-4">
                            <div class="alert alert-light border mb-4 text-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-info-circle-fill me-2 text-warning" viewBox="0 0 16 16">
                            ...
                            <div class="text-center">
                                <a href="{{ url('/') }}" class="btn btn-warning btn rounded-pill px-3 py-2 me-2">
