...
<div class="container py-5 d-flex align-items-center justify-content-center" style="min-height: 100vh;">
    <div class="col-md-8 col-lg-6">
        <div class="shadow-lg rounded-4 overflow-hidden" style="background-color: #fdf5e5; border-left: 10px solid #6B3A2C;">

            <!-- Logo arriba del formulario -->
            <div class="text-center py-2" style="background-color: #fdf5e5;">
                <img src="{{ asset('images/abogared2.png') }}" alt="Logo del despacho" style="max-width: 250px;" class="img-fluid mb-2">
            </div>
